...
//local imports
import { removeUser } from "redux/UserStore";
...
const Headers = () => {
  ...
  return (
    <div className=" w-full h-[100px] flex justify-between items-center px-2 sm:px-14 sticky top-0 bg-white z-50 ">
      <img
        onClick={() => navigate("/")}
        className="sm:w-52 w-32 cursor-pointer"
        src="https://www.freepnglogos.com/uploads/shopee-logo-png/shopee-logo-money-changers-with-the-best-exchange-rates-singapore-10.png"
        alt=""
      />
      ...
      <div className="flex gap-x-4 items-center">
        {user && names ? (
          ...
          <>
            <CustomButton size="sm" fullWidth={false} onClick={() => navigate("/auth/register")} variant="default" children="Register" />{" "}
            <CustomButton size="sm" fullWidth={false} onClick={() => navigate("/auth/login")} variant="default" children="Login " />{" "}
          </>
        )}
      </div>
    </div>
